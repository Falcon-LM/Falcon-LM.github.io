...
تروي الأرقام جزءًا مهمًا من القصة. على [لوحة الصدارة المفتوحة لنماذج اللغة العربية (OALL)](https://huggingface.co/spaces/OALL/Open-Arabic-LLM-Leaderboard)، وهي معيار شامل يقيّم فهم اللغة العربية عبر مهام متنوعة، يحقق Falcon-H1-Arabic نتائج رائدة  على جميع الأحجام التي قمنا باختبارها. نود الإشارة إلى أن نتائجنا قد تختلف قليلًا عن النتائج المعروضة على OALL ، وذلك لأننا استخدمنا vLLM كمحرّك بدلًا من تنفيذ Accelerate المستخدم في OALL. وعادةً ما تكون هذه الفروقات أقل من نقطة واحدة، مع توفير زمن تنفيذ أسرع بكثير.
